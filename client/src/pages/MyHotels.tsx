...
const MyHotels = () => {
  const { data: hotelData } = useQuery("fetchMyHotels", apiClient.getHotels, {
    onError: () => {},
  })
  ...
  return (
    <div className="space-y-5">
      <span className="flex justify-between">
        ...
        <Link
          to="/add-hotel"
          className="flex rounded-lg bg-blue-600 p-2 px-5 text-xl font-bold text-white hover:bg-blue-500"
        >
          Add Hotel
        </Link>
      </span>
